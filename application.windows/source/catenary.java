...
public class catenary extends PApplet {
...
public float catenaryParamDerivative(float a, float h) {
...
public float newtonGuess(float h, float k) {
...
public float newton(float h, float k, float guess) {
  ...
  while (abs(fx) > 0.001f && iterations < 5000) {
    x0 = x1;
...
public float catenary(float x, float a) {
...
public void draw() {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "catenary" });
  }
}
